          ...
          {showNav && (
            <div className=" h-[95vh] flex items-center justify-center">
              <ul className="pr-14 w-[80%] h-[40vh] text-white ">
                <li className="text-customPurple border text-white py-1 px-4 rounded mt-1  text-center hover:bg-white hover:text-customPurple">
                  Home
                </li>
                <li className="text-customPurple border text-white py-1 px-4 rounded mt-2  text-center hover:bg-white hover:text-customPurple">
                  About
                </li>
                <li className="text-customPurple border text-white py-1 px-4 rounded  mt-2 text-center hover:bg-white hover:text-customPurple">
                  Sponsors
